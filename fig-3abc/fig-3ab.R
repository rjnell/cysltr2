result_file = paste0("fig-3abc/fig-3a.png")
...
segments(xlim[1],yat,5+1,col="#eeeeee",lwd=1.4,xpd=T)
...
text(1.5, 1.2, col="#333333", labels="PUM-1A", xpd=T, font=2)  
...
arrows(x+0.5, data[2], x+0.5, data[3], length=0.05, angle=90, code=3, col="white", xpd=T, lwd=1.4)
text(x+0.5, -0.1, srt=60, adj=1, col="#333333", labels="RNA", xpd=T)  
text(4.5, 1.2, col="#333333", labels="PUM-2A", xpd=T, font=2)  


segments(xlim[1],1,5+1,col="#eeeeee",lwd=1.4,xpd=T)
segments(xlim[1],0,5+1,col="#b1b1b1",lwd=1.4,xpd=T)
segments(c(0,3),0,c(0,3),1, col="#b1b1b1", lwd=1.4)

y = .5625+0.03125
rect(x+2.6,y-0.0625,x+3.4,y+0.0625,col="#333333", border=NA)
text(x+3.4,y,col="#333333", labels = substitute(paste(italic('CYSLTR2')^"L129Q")), pos=4, xpd=T)

y=0.4375-0.03125
rect(x+2.6,y-0.0625,x+3.4,y+0.0625,col="#b1b1b1", border=NA)
...
result_file = paste0("fig-3abc/fig-3b.png")
...
yat = seq(from=ylim[1],to=ylim[2],by=0.5)
segments(xlim[1],yat,8+1,col="#eeeeee",lwd=1.4,xpd=T)
...
arrows(x+0.5, ci[1], x+0.5, ci[2], length=0.05, angle=90, code=3, col="white", xpd=T, lwd=1.4)
text(x+0.5, -0.1, srt=60, adj=1, col="#333333", labels="RNA", xpd=T)  
text(1.5, 1.2, col="#333333", labels="V4-A9ED", xpd=T, font=2)  
...
arrows(x+0.5, ci[1], x+0.5, ci[2], length=0.05, angle=90, code=3, col="white", xpd=T, lwd=1.4)
text(x+0.5, -0.1, srt=60, adj=1, col="#333333", labels="RNA", xpd=T)  
text(4.5, 1.2, col="#333333", labels="VD-AA8O", xpd=T, font=2)  
...
arrows(x+0.5, ci[1], x+0.5, ci[2], length=0.05, angle=90, code=3, col="white", xpd=T, lwd=1.4)
text(x+0.5, -0.1, srt=60, adj=1, col="#333333", labels="RNA", xpd=T)  
text(7.5, 1.2, col="#333333", labels="YZ-A982", xpd=T, font=2)  


segments(xlim[1],1,8+1,col="#eeeeee",lwd=1.4,xpd=T)
segments(xlim[1],0,8+1,col="#b1b1b1",lwd=1.4,xpd=T)
segments(c(0,3,6),0,c(0,3,6),1, col="#b1b1b1", lwd=1.4)
